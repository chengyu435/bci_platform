...
def get_1020_positions():
    return {
        # ================= Frontal =================
        "FP1": (-2, 5), "FPZ": (0, 5), "FP2": (2, 5),

        "AF7": (-3, 4), "AF3": (-1.5, 4), "AFZ": (0, 4), "AF4": (1.5, 4), "AF8": (3, 4),

        # ================= Frontal =================
        "F7": (-4, 3), "F5": (-3, 3), "F3": (-2, 3), "F1": (-1, 3),
        "FZ": (0, 3),
        "F2": (1, 3), "F4": (2, 3), "F6": (3, 3), "F8": (4, 3),

        # ================= FC =================
        "FT7": (-4, 2), "FC5": (-3, 2), "FC3": (-2, 2), "FC1": (-1, 2),
        "FCZ": (0, 2),
        "FC2": (1, 2), "FC4": (2, 2), "FC6": (3, 2), "FT8": (4, 2),

        # ================= C =================
        "T7": (-5, 1), "C5": (-3, 1), "C3": (-2, 1), "C1": (-1, 1),
        "CZ": (0, 1),
        "C2": (1, 1), "C4": (2, 1), "C6": (3, 1), "T8": (5, 1),

        # ================= CP =================
        "TP7": (-5, 0), "CP5": (-3, 0), "CP3": (-2, 0), "CP1": (-1, 0),
        "CPZ": (0, 0),
        "CP2": (1, 0), "CP4": (2, 0), "CP6": (3, 0), "TP8": (5, 0),

        # ================= P =================
        "P7": (-4, -1), "P5": (-3, -1), "P3": (-2, -1), "P1": (-1, -1),
        "PZ": (0, -1),
        "P2": (1, -1), "P4": (2, -1), "P6": (3, -1), "P8": (4, -1),

        # ================= PO =================
        "PO7": (-3, -2), "PO3": (-1.5, -2), "POZ": (0, -2), "PO4": (1.5, -2), "PO8": (3, -2),

        # ================= O =================
        "O1": (-1, -3), "OZ": (0, -3), "O2": (1, -3),
